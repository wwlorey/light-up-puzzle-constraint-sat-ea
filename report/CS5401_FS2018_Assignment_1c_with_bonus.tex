...
The statistical analysis showed that for randomly generated puzzles, neither initialization method
...
of conditions that can only be fulfilled one way (such as a `3' valued black cell placed along an edge),
and since the search space is more difficult to traverse for highly difficult puzzles, Validity Enforced
Uniform Random initialization produces a higher performing EA for the provided puzzle.
